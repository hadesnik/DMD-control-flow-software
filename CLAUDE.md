...
> **Superseded 2026-08-17.** `docs/dmd_control_handoff.md` was the earlier name for
> this document and is no longer regenerated. Everything it got wrong — the
> objective (it assumed a Nikon CFI75 16×/0.8), the tube lens, and 1030 vs 1038 nm —
> is fixed in `optics_handoff.md`. The old file is kept only as history; do not cite
> it. The ⚠️ STALE banner that used to live here is retired: the regeneration it was
